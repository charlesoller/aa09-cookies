...
function restoreTheme() {
    ...
    if(cookie){
        ...
        // console.log("THEME", cookieParts)
        const singleCookie = cookieParts[1]
...
function storeName(displayName) {
    const nameCookie = `displayName=${displayName}`
...
function restoreName() {
    ...
    if(cookie){
        const cookieParts = cookie.split("; ")
        // console.log("NAME", cookieParts)
        const singleCookie = cookieParts[0]
        const name = singleCookie.split("=")[1]
